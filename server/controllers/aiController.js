...
export const removeImageBackground = async (req, res) => {
  try {
    ...
    // Add better error handling for Cloudinary upload
    ...
    try {
      ...
      throw new Error("Failed to process image: " + cloudinaryError.message);
    }
...
export const generateImage = async (req, res) => {
  try {
    ...
    try {
      ...
      console.error("ClipDrop API error:", apiError);
    ...
    try {
      ...
      console.error("Cloudinary upload error:", cloudinaryError);
      throw new Error("Failed to save image: " + cloudinaryError.message);
    }
...
export const removeImageObject = async (req, res) => {
  try {
    ...
    // Upload and process with error handling
    let uploadResult;
    try {
