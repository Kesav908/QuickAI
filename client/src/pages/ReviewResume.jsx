...
const ReviewResume = () => {
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex flex-wrap gap-4 text-slate-7--">
      {/* Left column - Form */}
      <form
      ...
      <div className="w-full md:w-[48%] p-1 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px] ">
        <div className="flex items-center gap-3">
        ...
        </div>
        {
          ...
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            ...
            <p>Upload an resume and click "Remove Review" to get started</p>
          </div>
        </div>
          ):(
