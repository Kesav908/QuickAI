...
const GenerateImages = () => {
  const ImageCategory = ['Realistic','Ghibli Style','Anime Style','Cartoon Style','Fantasy Style','3D style','Potrait Style']
    ...
    const onSubmitHandler = async (e) => {
      ...
      try {
        ...
        const prompt=`Generate an image of ${input} in style ${ImageCategory}` 
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex flex-wrap gap-4 text-slate-700">
      ...
      <form
        ...
        className="w-full md:w-[48%] p-4 bg-white rounded-lg border border-gray-200"
      >
        ...
        <textarea
          ...
          className="w-full p-4 mt-2 outline-none text-sm rounded-md border border-gray-300"
      ...
      <div className="w-full md:w-[48%] p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
